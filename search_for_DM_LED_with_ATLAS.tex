\documentclass[10pt,twoside,cucitura,classica,openany]{toptesi}

%%% This is for the Swedish state paper format:
\usepackage{geometry}
\geometry{
  paperwidth=165mm,
  paperheight=242mm,
...
\NewBibliographyString{licentiate}{\DefineBibliographyStrings{english}{
...
\input{monojet_sig_2016/results_intro}
