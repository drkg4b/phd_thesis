...
\begin{table}[!ht]
  ...
  \begin{tabular}{lcccccccccc}
    ...
    \bottomrule
  \end{tabular}}
\caption{Systematic uncertainties in \% on PDFs for the V + jets background as a
  function of the exclusive signal regions EM1-EM10. The uncertainties on a
  given process are quoted in the region where this process is dominant. Due to
  the lack of variation wights the $\zeeplusjets$ uncertainty is used for the
