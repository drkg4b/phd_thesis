...
samples to the \gls{nlo} \note{Why do we apply NLO corrections to something that
  is already at NLO?} in \gls{qcd} and \gls{nlo} plus \gls{nll} Sudakov
approximation at \gls{nnlo} in \gls{ew} \note{Very confusing!! And what has this
  to do with the fact we have a \gls{nnlo} inclusive cross
  section?}~\cite{VplusJetsCorrections}. At high energies \gls{ew} corrections
